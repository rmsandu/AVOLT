...
from AVOLT.plots import graphing
from AVOLT.plots import mev_miv_scatter
from AVOLT.plots import subplots_pav_eav_scatter
...
def write_descriptive_stats(df_radiomics_PAV_EAV, device_name):
    ...
    df['Elongation_ablation'] = df_radiomics_PAV_EAV['elongation_ablation']
    df['Sphericity_ablation'] = df_radiomics_PAV_EAV['sphericity_ablation']
    df["diameter3D_tumor"] = df_radiomics_PAV_EAV["diameter3D_tumor"]
    df["diameter3D_ablation"] = df_radiomics_PAV_EAV["diameter3D_ablation"]
...
if __name__ == '__main__':
    ...
    mev_miv_scatter.connected_mev_miv(df_radiomics_PAV_EAV)
